...
{	
	private const string ONLINE_DOC_URL = "https://dl.dropboxusercontent.com/u/8289407/StopTheWheel/Documentation/html/annotated.html";
	private const string RATEUS_URL = "http://u3d.as/qF6";
	...
	[MenuItem("Tools/APP ADVISORY/Stop The Wheel/Welcome Screen", false, 0)]
	[MenuItem("Window/APP ADVISORY/Stop The Wheel/Welcome Screen", false, 0)]
	...
	void OnEnable(){
		#if UNITY_5_3
		titleContent = new GUIContent("Welcome To Stop The Wheel"); 
		#endif
